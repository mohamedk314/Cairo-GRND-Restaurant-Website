...
if(isset($_POST["add_to_sandwitch"]))
{
	if(isset($_SESSION["sandwitch"]))
	{
		$item_array_id = array_column($_SESSION["sandwitch"], "item_id");
		if(!in_array($_GET["id"], $item_array_id))
		{
			$count = count($_SESSION["sandwitch"]);
			$item_array = array(
				'item_id'			=>	$_GET["id"],
			...
			$_SESSION["sandwitch"][$count] = $item_array;
		}
		else
		{
	...
	else
	{
		...
		$_SESSION["sandwitch"][0] = $item_array;
	}
}
...
<head>
  ...
  left: 35%;">Compose a sandwich</h6><br />
	<body>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM compose ORDER BY id ASC";
    ...
    <?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="compose.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align:center>
						<img src="images/compose/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
						...
						<input type="submit" name="add_to_sandwitch" style="margin-top:5px;" class="btn btn-success" value="Add to Sandwitch" />
 ...
 <button style="margin-top:5px;" type="button" class="btn btn-secondary" onclick="window.location.href='hpu.php'" >continue browsing</button>
                ...
                <img  src="images/errors/errorsandwitch.jpg" class="img-responsive" /><br />
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<?php
                            ...
                            $_SESSION['total_price_compose'] = $total;
						}
					?>
					<tr>
